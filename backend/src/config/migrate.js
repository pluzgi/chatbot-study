...
CREATE TABLE IF NOT EXISTS donation_decisions (
    id UUID PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS idx_donation_decisions_participant ON donation_decisions(participant_id);
CREATE INDEX IF NOT EXISTS idx_donation_decisions_condition ON donation_decisions(condition);
CREATE INDEX IF NOT EXISTS idx_post_task_measures_participant ON post_task_measures(participant_id);
`;
