  ...
  return (
    <div className="fixed inset-0 flex flex-col max-w-4xl mx-auto bg-gray-50">
      ...
      <div className="flex-1 overflow-y-auto p-3 md:p-4 space-y-3 md:space-y-4 min-h-0">
        ...
        {loading && (
          <div className="flex justify-start">
            <div className="bg-gray-200 text-gray-600 rounded-lg px-4 py-2 text-sm md:text-base">
              {t('chat.thinking')}
            </div>
          </div>
        )}
      ...
      <div className="flex-shrink-0 bg-white border-t border-gray-200">
        ...
        {maxReached && (
          <div className="px-4 py-2 text-center text-sm text-green-700 bg-green-50 border-t border-green-200">
            {t('chat.maxReached')}
          </div>
        )}
        ...
        {/* Validation error */}
        {showValidation && (
          <div className="px-4 py-2 text-center text-sm text-red-700 bg-red-50 border-t border-red-200">
        ...
        {canContinue && !loading && (
          <div className="p-3 md:p-4 bg-green-50 border-t border-green-200">
            <button
              ...
              className="w-full bg-gray-200 text-black py-3 md:py-4 rounded-lg font-semibold text-base min-h-[48px] hover:bg-green-600 hover:text-white transition"
            >
