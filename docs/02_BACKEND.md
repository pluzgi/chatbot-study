...
// Record donation decision (also increments donation_accepted/donation_declined counter)
...
// Record post-task survey measures (also increments survey_completed counter)
